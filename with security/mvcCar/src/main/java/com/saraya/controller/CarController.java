...
public class CarController {
	...
	//---------------initializing 1st the logger for the exception method---
	...
	public String carAdded(ModelMap model, @Valid @ModelAttribute("vehicle")
											Car c, BindingResult result) {
		if(result.hasErrors()) {
			return "addCar";
		}
	...
	public String carListUpdate(ModelMap model, @Valid
										@ModelAttribute("vehicle") Car c,
